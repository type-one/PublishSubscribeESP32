...
namespace
{
    ...
    TEST(SharedResultTest, then_value_transforms_success)
    {
        ...
        auto chained = shared.then_value([](const int& value) { return value * 3; });
    ...
    TEST(SharedResultTest, then_value_propagates_error)
    {
        ...
        auto chained = shared.then_value([](const int& value) { return value * 2; });
    ...
    TEST(SharedResultTest, then_error_recovers_error)
    {
        ...
        auto chained = shared.then_error([](pco::result_error) { return 123; });
    ...
    TEST(SharedResultTest, then_result_receives_full_expected)
    {
        ...
        auto chained = shared.then_result(
            [](const pco::shared_result<int>::result_type& res) { return res.has_value() ? res.value() + 1 : -1; });
    ...
    TEST(SharedResultTest, then_value_executor_dispatches)
    {
        ...
        auto chained = shared.then_value(pco::inplace_executor, [](const int& value) { return value + 8; });
    ...
    TEST(SharedResultTest, then_result_executor_dispatches)
    {
        ...
        auto chained = shared.then_result(pco::inplace_executor,
            [](const pco::shared_result<int>::result_type& res) { return res.has_value() ? res.value() * 2 : 0; });
    ...
    TEST(SharedResultTest, then_value_supports_move_only_value_by_const_reference)
    {
        ...
        auto chained = shared.then_value([](const std::unique_ptr<int>& ptr) { return *ptr + 5; });
    ...
    TEST(SharedResultTest, void_then_value_transforms_success)
    {
        ...
        auto chained = shared.then_value([]() { return 77; });
    ...
    TEST(SharedResultTest, void_then_error_recovers_error)
    {
        ...
        bool invoked = false;
        auto chained = shared.then_error([&](pco::result_error) { invoked = true; });
    ...
    TEST(SharedResultTest, void_then_result_executor_dispatches)
    {
        ...
        auto chained = shared.then_result(pco::inplace_executor,
            [](const pco::shared_result<void>::result_type& res) { return res.has_value() ? 1 : 0; });
    ...
    TEST(SharedResultTest, notify_runs_when_shared_becomes_ready)
    {
        ...
        shared.notify([&]() { notifications.fetch_add(1); });
    ...
    TEST(SharedResultTest, notify_executor_dispatches_callback)
    {
        ...
        std::atomic<int> notifications { 0 };
        shared.notify(pco::inplace_executor, [&]() { notifications.fetch_add(1); });
    ...
    TEST(SharedResultTest, all_then_value_continuations_are_invoked)
    {
        ...
        auto cnt1 = shared.then_value(
            [&executed1](const int&)
            {
                executed1 = true;
                return 0;
            });
        auto cnt2 = shared.then_value(
            [&executed2](const int&)
            {
                executed2 = true;
                return 0;
    ...
    TEST(SharedResultTest, continuation_attached_after_readiness_fires_inline)
    {
        ...
        bool executed = false;
        auto cnt = shared.then_value(
            [&executed](const int& v)
            {
                executed = true;
                return v;
            });
