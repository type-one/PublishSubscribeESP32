...
/**
 * \brief Verifies should execute function in another thread for thread pool.
 */
...
/**
 * \brief Verifies processes all queued tasks when waited on for thread pool.
 */
...
/**
 * \brief Verifies abandons unprocessed tasks when stopped for thread pool.
 */
