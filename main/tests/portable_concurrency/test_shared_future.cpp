...
/**
 * \brief Verifies retrieve result for shared future.
 */
...
/**
 * \brief Verifies retrieve exception for shared future.
 */
...
/**
 * \brief Verifies retreive result from several futures for shared future.
 */
...
/**
 * \brief Verifies wait awakes on value for shared future.
 */
...
#if !defined(PC_NO_DEPRECATED)
/**
 * \brief Verifies wait for awakes on value for shared future deprecated.
 */
...
#if !defined(PC_NO_DEPRECATED)
/**
 * \brief Verifies wait until awakes on value for shared future deprecated.
 */
...
/**
 * \brief Verifies wait awakes on error for shared future.
 */
...
#if !defined(PC_NO_DEPRECATED)
/**
 * \brief Verifies wait for awakes on error for shared future deprecated.
 */
...
/**
 * \brief Verifies wait until awakes on error for shared future deprecated.
 */
