...
/**
 * \brief Verifies is called when future becomes ready for future notify.
 */
...
/**
 * \brief Verifies is called when future becomes ready with error for future notify.
 */
...
/**
 * \brief Verifies is called when attached to ready future for future notify.
 */
...
/**
 * \brief Verifies is called when promise is broken for future notify.
 */
...
/**
 * \brief Verifies is called only once for future notify.
 */
...
/**
 * \brief Verifies is not called before future becomes ready for future notify.
 */
...
/**
 * \brief Verifies is not called if future destroyed before being set for future notify.
 */
...
/**
 * \brief Verifies is called for task running asyncroniusly for future notify.
 */
...
/**
 * \brief Verifies schedules notification with specified executor for future notify.
 */
