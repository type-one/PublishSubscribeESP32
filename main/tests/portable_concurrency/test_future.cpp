...
/**
 * \brief Verifies is ready on future with value for future.
 */
...
/**
 * \brief Verifies is ready on future with error for future.
 */
...
/**
 * \brief Verifies retrieve result for future.
 */
...
/**
 * \brief Verifies retrieve exception for future.
 */
...
/**
 * \brief Verifies wait on ready value for future.
 */
...
/**
 * \brief Verifies wait on ready error for future.
 */
...
#if !defined(PC_NO_DEPRECATED)
/**
 * \brief Verifies wait timeout for future.
 */
...
/**
 * \brief Verifies wait awakes on value for future.
 */
...
#if !defined(PC_NO_DEPRECATED)
/**
 * \brief Verifies wait for awakes on value for future.
 */
...
/**
 * \brief Verifies wait until awakes on value for future.
 */
...
/**
 * \brief Verifies wait awakes on error for future.
 */
...
#if !defined(PC_NO_DEPRECATED)
/**
 * \brief Verifies wait for awakes on error for future.
 */
...
#if !defined(PC_NO_DEPRECATED)
/**
 * \brief Verifies wait until awakes on error for future.
 */
...
/**
 * \brief Verifies ready future maker for future.
 */
...
/**
 * \brief Verifies error future maker from exception val for future.
 */
