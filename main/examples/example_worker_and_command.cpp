...
/** @brief Demonstrates using a @c tools::sync_ring_buffer of @c std::function callables as a fixed-capacity command ring queue. */
...
/** @brief Demonstrates concurrent work distribution across two worker tasks with randomised delegation and timing measurements. */
...
/** @brief Exercises perfect-forwarding delegate overloads of @c tools::worker_task with lvalue, rvalue, conversion, and batch dispatch variants. */
