...
namespace
{
/** @brief Demonstrates basic push/pop operations and boundary behaviour (full/empty) of @c tools::lock_free_ring_buffer. */
...
/** @brief Exercises push/pop_opt overloads of @c tools::lock_free_ring_buffer with integer lvalue, rvalue, and implicit-conversion inputs. */
...
/** @brief Demonstrates push_range (initialiser list and vector) and iterator-pair pop_range on a @c tools::lock_free_ring_buffer. */
...
/** @brief Stress-tests @c tools::lock_free_ring_buffer with concurrent producer and consumer generic tasks, verifying checksum integrity and throughput. */
...
/** @brief Exercises push/emplace/push_range/pop_range overloads of @c tools::sync_ring_buffer with string lvalue, rvalue, conversion, and move-only element types. */
...
/** @brief Exercises push/emplace/push_range/pop_range overloads of @c tools::sync_ring_vector with string lvalue, rvalue, conversion, and move-only element types. */
...
/** @brief Exercises push/emplace/push_range/pop_range overloads of @c tools::sync_queue with lvalue, rvalue, implicit conversion, brace-init, range-view, and move-only inputs. */
