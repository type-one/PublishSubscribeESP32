...
namespace
{
    ...
    /** @brief Exercises push/emplace/pop_move overloads of @c tools::ring_buffer with string lvalue, rvalue,
     * implicit-conversion, and move-only element types. */
    ...
    /** @brief Exercises push/emplace/push_range/pop_range overloads of @c tools::ring_vector with lvalue, rvalue,
     * implicit-conversion, and move-only element types. */
    ...
    /** @brief Demonstrates resizing a @c tools::ring_vector while it holds elements and verifies that capacity grows
    ...
    /** @brief Demonstrates index-based iteration, front/back access, and statistical computations (avg, variance,
     * min/max) over a @c tools::ring_buffer. */
    ...
    /** @brief Demonstrates index-based iteration, front/back access, and statistical computations (avg, variance,
     * min/max) over a @c tools::ring_vector. */
